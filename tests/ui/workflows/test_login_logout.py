...
from libs.ui.locators import LoginPageSelectors, NavigationBarSelectors
...
class TestLogin:
    ...
    def test_login(self, chrome):
        ...
        assert home.wait_for_url().get_enabled_state(
            (by, xpath.format(user_name="A"))
        ), "Login failed"
    ...
    def test_user_nav_bar(self, chrome):
        ...
        assert home.get_enabled_state(
            NavigationBarSelectors.EXPLORE_PREMIUM_BUTTON
        )
        ...
        assert home.get_enabled_state(
            NavigationBarSelectors.FRIEND_ACTIVITY_BUTTON
        )
    ...
    def test_logout(self, chrome):
        ...
        home.nav_bar.logout()
        assert home.wait_for_url().get_enabled_state(
            NavigationBarSelectors.LOGIN_BUTTON
        )
