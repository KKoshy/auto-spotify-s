...
class TestCreatePlaylist:
    ...
    def test_add_track_to_playlist(self, chrome):
        ...
        details.should_have_track_in_playlist(
    ...
    def test_remove_track_from_playlist(self, chrome):
        ...
        details = PlaylistDetailsPage(driver, playlist_data.pl_id)
        details.remove_track_from_playlist(
            "Believer", "Imagine Dragons", "Evolve"
        )
        details.should_not_have_track_in_playlist(
            "Believer", "Imagine Dragons", "Evolve"
        )
    ...
    def test_delete_playlist(self, chrome):
        ...
        home.left_side_menu.should_not_have_playlist(
