...
class PlaylistsAPI(UserSession):
    ...
    @log_handler
    def get_playlist(
        self, playlist_id: str, ignore_handle_response: bool = False
    ) -> Response:
        """
        ...
        return self.process_request(
            request_method=self.cu_session.get,
            url=self._get_path(f"playlists/{playlist_id}"),
            ignore_handle_response=ignore_handle_response,
        )

    @log_handler
    def update_playlist_details(
        self, playlist_id: str, json: dict, ignore_handle_response: bool = False
    ) -> Response:
        """
    ...
    def add_playlist_items(
        ...
        """
        return self.process_request(
            request_method=self.cu_session.post,
            url=self._get_path(f"playlists/{playlist_id}/tracks"),
            json=json,
            ignore_handle_response=ignore_handle_response,
            status_code=status_code,
    ...
    def get_current_user_playlists(
        ...
        return self.process_request(
            request_method=self.cu_session.get,
            url=self._get_path("me/playlists"),
            ignore_handle_response=ignore_handle_response,
            status_code=status_code,
            json_schema=json_schema,
        )
    ...
    def get_user_playlists(
        self, user_id: str, ignore_handle_response: bool = False
    ) -> Response:
        """
        ...
        return self.process_request(
            request_method=self.cu_session.get,
            url=self._get_path(f"users/{user_id}/playlists"),
            ignore_handle_response=ignore_handle_response,
        )

    @log_handler
    def create_playlist(
        self, user_id: str, json: dict, ignore_handle_response: bool = False
    ) -> Response:
        """
    ...
    def get_playlist_cover_image(
        ...
        return self.process_request(
            request_method=self.cu_session.get,
            url=self._get_path(f"playlists/{playlist_id}/images"),
            ignore_handle_response=ignore_handle_response,
        )
