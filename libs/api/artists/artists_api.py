...
class ArtistsAPI(AppSession):
    ...
    @log_handler
    def get_artists(
        self, artist_ids: list[str], ignore_handle_response: bool = False
    ) -> Response:
        """
    ...
    def get_artist_albums(
        ...
        return self.process_request(
            request_method=self.cu_session.get,
            url=self._get_path(f"artists/{artist_id}/albums"),
            params=qparams,
            ignore_handle_response=ignore_handle_response,
        )
    ...
    def get_artist_top_tracks(
        ...
        return self.process_request(
            request_method=self.cu_session.get,
            url=self._get_path(f"artists/{artist_id}/top-tracks"),
            params=qparams,
            ignore_handle_response=ignore_handle_response,
        )
    ...
    def get_artist_related_artists(
        self, artist_id: str, ignore_handle_response: bool = False
    ):
        """
        :NOTE: Deprecated
        ...
        return self.process_request(
            request_method=self.cu_session.get,
            url=self._get_path(f"artists/{artist_id}/related-artists"),
            ignore_handle_response=ignore_handle_response,
        )
